                    ...
                    <div className='container'>
                        <form onSubmit={handleFormSubmit}>
                            ...
                            <div className='mb-3'>
                                ...
                                <input type='number' defaultValue = {0.0} step="any" onChange={handleInputChange} className='form-control' id='amount' name='amount' value={FormData.amount} />
                            </div>
                            ...
                            <div className='mb-3'>
                                ...
                                <input type='checkbox' style={{ width: "25px", padding:0 }} onChange={handleInputChange} id='chase_card' name='chase_card' value={FormData.chase_card} />
                            </div>
                            ...
                            <div className='mb-3'>
                                ...
                                <input type='checkbox' style={{ width: "25px", padding:0 }} onChange={handleInputChange} id='amazon_card' name='amazon_card' value={FormData.amazon_card} />
                            </div>
                            ...
                            <div className='mb-3'>
                                ...
                                <input type='checkbox' style={{ width: "25px", padding:0 }} onChange={handleInputChange} id='paid' name='paid' value={FormData.paid} />
                            </div>
